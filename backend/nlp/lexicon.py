...
interface e o banco já usam (ex.: chips de diagnóstico, próxima ação), para que
o novo motor seja um substituto direto do antigo.
"""

from backend.nlp.vocabulary import Term, Vocabulary
